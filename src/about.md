...
on some Git-as-a-Service platforms, such as [Codeberg][cb], [GitHub][gh], and
[GitLab][gl]. As I work for a contractor, sometimes I am required to use
VCS accounts that are not my own, and this activity is not reflected in any
gamification metrics you see on these platforms. I may have account activity
turned off on these platforms.

If you want to contact me, you can do so via [email][1].

[1]: mailto:hello@amber.vision
[cb]: https://codeberg.org/amberstarlight
